        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-6">
          <div className="space-y-2">
            ...
            {errors.includes("title") && (
              <p className="text-xs text-red-400">제목을 입력해줘.</p>
            )}
          </div>

          <div className="space-y-2">
            <label className="text-xs text-zinc-400">캐릭터</label>
            <input
            ...
            {errors.includes("character") && (
              <p className="text-xs text-red-400">캐릭터를 입력해줘.</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {errors.includes("type") && (
              <p className="text-xs text-red-400">타입을 입력해줘.</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {errors.includes("tags") && (
              <p className="text-xs text-red-400">태그를 하나 이상 입력해줘.</p>
            )}
          </div>

          <div className="space-y-2">
            <label className="text-xs text-zinc-400">출처 링크 (선택)</label>
            <input
